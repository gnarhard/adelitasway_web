...
<section class="py-16 sm:py-20 px-5 sm:px-10 max-w-[1200px] mx-auto border-b border-[#7BBEFD]/10">
  ...
  <h2 class="text-2xl sm:text-[32px] font-bold tracking-tight text-[#f0f0f0] mb-2" style="font-family: 'Inter', sans-serif;">This Is What Fans See</h2>
  <p class="text-[17px] text-[#b8b8d0] mt-2 max-w-[700px] leading-relaxed">The app is going to be full of real imagery &mdash; live shots, band photos, album art, behind-the-scenes stuff. Here's a taste of what's going in. More photos and artwork will be added as the build progresses.</p>
...
<section class="py-16 sm:py-20 px-5 sm:px-10 max-w-[1200px] mx-auto border-b border-[#7BBEFD]/10">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8">
    ...
    <div class="bg-[#0e0e20] border border-[#7BBEFD]/10 rounded-xl p-7"><h4 class="text-base font-semibold text-[#f0f0f0] mb-2" style="font-family:'Inter',sans-serif">One place the money goes</h4><p class="text-sm text-[#b8b8d0] leading-relaxed">Everything &mdash; unlocks, bundles, VIP packages &mdash; runs through Stripe. One payment processor, one bank account. No reconciliation, no spreadsheet nightmares.</p></div>
    ...
    <div class="bg-[#0e0e20] border border-[#7BBEFD]/10 rounded-xl p-7"><h4 class="text-base font-semibold text-[#f0f0f0] mb-2" style="font-family:'Inter',sans-serif">No middlemen</h4><p class="text-sm text-[#b8b8d0] leading-relaxed">No DistroKid, no TuneCore, no label taking a cut of streaming revenue. The music lives in the app, the real products make the money, and 100% of the margin stays with you.</p></div>
  </div>
</section>
